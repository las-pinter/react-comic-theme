...
if (!class_exists('Comic_Theme_Menu_Rest_API')) :
    class Comic_Theme_Menu_Rest_API
    {
        /**
    ...
    add_action('rest_api_init', array('Comic_Theme_Menu_Rest_API', 'register_routes'));
